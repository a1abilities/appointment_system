export const API_URL = 'http://appointment.connectivitysoftwaresolutions.com'; // Config[KEY].API_URL;
export const AUTH_URL = 'http://appointment.connectivitysoftwaresolutions.com'; // Config[KEY].AUTH_URL;
export const API_CONSUMER = 'http://appointment.connectivitysoftwaresolutions.com'; // Config[KEY].API_URL;
